            ...
            if(image.at<uchar>(i,j)==255){
                ...
                while(pilha[0][0]!=-1){
                    ...
                    if(image.at<uchar>(pilha[pilha_pos][0],pilha[pilha_pos][1]-1)==255){
                        image.at<uchar>(pilha[pilha_pos][0],(pilha[pilha_pos][1]-1))=0;
                        //pilha_pos++;
                        contPilhaPos++;
                    ...
                    if(image.at<uchar>(pilha[pilha_pos][0]+1,pilha[pilha_pos][1])==255){
                        ...
                        //mudar cor
                        image.at<uchar>(pilha[pilha_pos][0]+1,pilha[pilha_pos][1])=0;
                        //pilha_pos++;
                        contPilhaPos++;
                    ...
                    for(int aux=0;aux<contPilhaPos&&aux<49;aux++){
                        pilha[aux][0]=pilha[aux+1][0];
                        pilha[aux][1]=pilha[aux+1][1];

                    }
                    for(int aux1=contPilhaPos;aux1<50;aux1++){
                            pilha[aux1][0]=-1;
                            pilha[aux1][1]=-1;
